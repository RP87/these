...
Une fois (i) reconnue comme systématique à tout procédé et (ii) abordée sous l'angle de la multi-dimensionnalité, la problématique est résolue de façon courante via les \gls{ADMC} de la décennie 70 et dont nous avons proposé deux articulations. %,ma préférence allant à l'expansion pure.

% reformer des normes iso ilcd et canons de la décision multicritère
Le traitement de ce problème global étant maintenant clair il faut qu'il intègre le cadre normalisé de la discipline.
...
\textbf{Mais pour les décisions en groupe distribué, nécessaire à la soutenabilité, les caractéristiques du modèle actuel du vote démocratique~: transparence, confidentialité, anonymat, unicité, sincérité, ne peuvent être validées.}%\footnote{Même les forts intéressantes recherche sur les applications des 'block chain' n'ôtent le caractère "confiscatoire" ou "déappropriant" d'un outils d'une tel technicité et complexité.}
...
Notre travail, relevant les idéologies dominantes et leur imbrication à l'outil d'évaluation, souligne combien il n'y a d'économie, que d'\emph{\textbf{économie politique}}, au sens de sa critique marxienne. %sortie comme ça c'est sans doute trop imprécis. Est-ce que cette formulation, qui a pour destinaire les économistes va être interprété au sens ou je perçois le langage des économistes sans en être un ? "au sens d'un rapport de classes qui détermine 'ce qui fait valeur et comment le compter'" ? Moins d'erreur possible ?
...
%Un point qui nécessiterait, au plan opérationnel bien plus de travaux, serait de déterminer s'il est possible sur la base d'un 'slow-net' de maintenir une infrastructure informatique suffisante dans un avenir post-civilisation thermo-industriel que l'ÉHO soit un jour une réalité.
